import Player from "../player/Player.js?v=127";
import DialogSystem from "../systems/DialogSystem.js?v=127";
import InteractionSystem from "../systems/InteractionSystem.js?v=127";
import ChatSystem from "../systems/ChatSystem.js?v=127";
import MultiplayerSystem from "../systems/MultiplayerSystem.js?v=127";
