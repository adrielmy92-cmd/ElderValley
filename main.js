...
import GamePreloadScene from "./scenes/GamePreloadScene.js?v=254";
import TitleScene from "./scenes/TitleScene.js?v=258";
import WorldScene from "./scenes/WorldScene.js?v=290";
import VillageWestScene from "./scenes/VillageWestScene.js?v=67";
