...
import GamePreloadScene from "./scenes/GamePreloadScene.js?v=230";
import TitleScene from "./scenes/TitleScene.js?v=237";
import WorldScene from "./scenes/WorldScene.js?v=248";
import VillageWestScene from "./scenes/VillageWestScene.js?v=27";
import CemeteryScene from "./scenes/CemeteryScene.js?v=17";
import CityScene from "./scenes/CityScene.js?v=225";
...
import ForestScene from "./scenes/ForestScene.js?v=39";
import SwampScene from "./scenes/SwampScene.js?v=32";
import BeeScene from "./scenes/BeeScene.js?v=17";
