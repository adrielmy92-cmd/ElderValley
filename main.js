...
import WorldScene from "./scenes/WorldScene.js?v=282";
import VillageWestScene from "./scenes/VillageWestScene.js?v=59";
import CemeteryScene from "./scenes/CemeteryScene.js?v=49";
import CityScene from "./scenes/CityScene.js?v=257";
...
import CardShopHouseScene from "./scenes/CardShopHouseScene.js?v=247";
import MiddleForgeInteriorScene from "./scenes/MiddleForgeInteriorScene.js?v=248";
import ReferenceHouseInteriorScene from "./scenes/ReferenceHouseInteriorScene.js?v=247";
...
import ForestScene from "./scenes/ForestScene.js?v=71";
import SwampScene from "./scenes/SwampScene.js?v=64";
import BeeScene from "./scenes/BeeScene.js?v=49";
