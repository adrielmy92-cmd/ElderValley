...
import GamePreloadScene from "./scenes/GamePreloadScene.js?v=224";
...
import CemeteryScene from "./scenes/CemeteryScene.js?v=5";
...
import AlchemistHouseInteriorScene from "./scenes/AlchemistHouseInteriorScene.js?v=213";
