...
import TitleScene from "./scenes/TitleScene.js?v=210";
import WorldScene from "./scenes/WorldScene.js?v=209";
...
import MiddleForgeInteriorScene from "./scenes/MiddleForgeInteriorScene.js?v=209";
